...
use NicMart\Generics\Example\PHP7\Option\None«RelativeName»;
use NicMart\Generics\Example\PHP7\Option\None«FullName»;
use NicMart\Generics\Example\PHP7\Option\None«string»;

use NicMart\Generics\Example\PHP7\Option\OptionMap«FullName·RelativeName»;
use NicMart\Generics\Example\PHP7\Option\OptionMap«FullName·string»;

use NicMart\Generics\Name\FullName;
use NicMart\Generics\Name\RelativeName;

use NicMart\Generics\Example\PHP7\Option\Some«string»;
use NicMart\Generics\Example\PHP7\Option\Option«string»;
...
use NicMart\Generics\Example\PHP7\Func\CallableFunction1«FullName·Option«RelativeName»»;
use NicMart\Generics\Example\PHP7\Func\CallableFunction1«FullName·Option«string»»;
