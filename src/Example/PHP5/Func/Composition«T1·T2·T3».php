...
use NicMart\Generics\Example\PHP5\Func\Function1«T1·T3»;
use NicMart\Generics\Example\PHP5\Func\Function1«T2·T3»;

class Composition«T1·T2·T3» implements Function1«T1·T3», Generic
{
    /**
     * @var \NicMart\Generics\Example\PHP5\Func\Function1«T2·T3»
     */
    private $f;
    /**
     * @var \NicMart\Generics\Example\PHP5\Func\Function1«T1·T2»
     */
    private $g;
